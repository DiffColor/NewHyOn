...
class StartupRenderContractTests(unittest.TestCase):
    ...
    def test_schedule_page_loads_specials_after_first_frame_off_ui_thread(self):
        ...
        loaded_body = method_body(source, "private void UserControl_Loaded")
        ...
        unloaded_body = method_body(source, "private void UserControl_Unloaded")

        self.assertNotIn("LoadAllSpecials();", loaded_body)
        self.assertIn("LoadAllSpecialsAsync();", loaded_body)
        ...
        self.assertIn("CancelSpecialLoad();", unloaded_body)
    ...
    def test_playlist_page_virtualizes_saved_pages_and_loads_previews_lazily(self):
        ...
        refresh_body = method_body(page_source, "public void RefreshSavedPageList")
