...
public partial class CustomDialog : Window
{
    ...
    public CustomDialog(string title, string message, string? subtitle = null, string primaryButtonText = "확인", string? secondaryButtonText = null)
    {
        ...
        DialogSubtitleTextBlock.Text = hasCustomSubtitle ? subtitle : "NewHyOn Player Settings";
    ...
    {
        CustomDialog dialog = new(title, message, subtitle)
        {
            Owner = owner
        };
    ...
    {
        CustomDialog dialog = new(title, message, subtitle, primaryButtonText, secondaryButtonText)
        {
            Owner = owner
        };
