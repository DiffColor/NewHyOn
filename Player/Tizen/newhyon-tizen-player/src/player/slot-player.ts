...
interface PreparedContentTarget {
...
export class SlotPlayer {
  ...
  private boundaryNextContentTarget: PreparedContentTarget | null = null;
  ...
  setBoundaryNextContentTarget(target: PreparedContentTarget | null): void {
    this.boundaryNextContentTarget = target;
  }
  ...
  private resolvePreparedContentTarget(): PreparedContentTarget | null {
    if (this.canAdvanceContent()) {
      const nextIndex = this.resolvePreparedItemIndex();
      if (nextIndex !== null) {
    ...
    const boundaryTarget = this.boundaryNextContentTarget;
    if (!boundaryTarget || boundaryTarget.item.id === this.currentItem()?.id) {
      return null;
    }
